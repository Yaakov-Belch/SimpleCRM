...
from app.models import Activity, Attachment, Contact, Session, User  # Import models to register them
from app.routers import activities, attachments, auth, contacts, users
